...
public class AlzzaMPagerAdapter extends PagerAdapter {
    ...
    public AlzzaMPagerAdapter(Context context, int startNum, int endNum, int itemHeight,
            int listCnt) {
        mContext = context;
    ...
    private void appendNumberView(int position, LinearLayout container) {
        ...
        numberView.setLayoutParams(new LinearLayout.LayoutParams(0, itemHeight, 1.0f));
